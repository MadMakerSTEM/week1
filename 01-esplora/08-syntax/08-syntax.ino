/* This program flashes the LED between red and blue at a given speed determined
   by the position of the slider. The program saves the value of the slider into
